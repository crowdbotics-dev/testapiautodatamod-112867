...
## Project Structure
    ...
    ├── testapiautodatamod_112867  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_112867`
...
2. Clone this repo and `cd testapiautodatamod_112867`
